...
import * as storage from '../storage/data'

const router = Router();

router.get('/', async (req, res, next) => {

  /* Here we should get our data from DB  */
...
router.post('/', async (req, res, next) => {
  ...
  /* Here we should save our data into DB  */
...
router.delete('/:id', async (req, res, next) => {
  const newBody = await storage.remove(req.params['id']);
