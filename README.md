## Minecraft 3D Net Game

<p>Финальный таск RSSchool</p>
...
[Деплой Приложения](https://rsclone-minecraft.netlify.app)

[Сервер (Git)](https://github.com/addamsv/The-Minecraft-Game-Clone/tree/server)
